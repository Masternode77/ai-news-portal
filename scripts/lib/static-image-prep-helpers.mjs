...
function fallbackSvg(slug = 'ai-infrastructure') {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630" role="img" aria-label="Compute Current ${escapeXml(label)} editorial illustration">
  <defs>
  ...
  <text x="104" y="506" fill="#d6dfef" font-family="Inter, Arial, sans-serif" font-size="22" font-weight="720">Compute Current editorial briefing</text>
</svg>`;
}
