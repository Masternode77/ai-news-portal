...
- Primary public data: `src/data/latest-news.json` (43 records).
- Archive data: `src/data/archived-news.json` (968 records).
...
- Retained source-only/direct-link items: 1006.
