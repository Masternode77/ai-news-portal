...
- Current public homepage cards after product-fit and source-rights gates: 31. Retained JSON records are not treated as reader-visible cards.
...
- Primary public data: `src/data/latest-news.json` (39 records).
- Archive data: `src/data/archived-news.json` (966 records).
...
- Retained source-only/direct-link items: 1000.
