...
- Current public homepage cards after product-fit and source-rights gates: 16. Retained JSON records are not treated as reader-visible cards.
...
- Archive data: `src/data/archived-news.json` (929 records).
...
- Retained source-only/direct-link items: 959.
