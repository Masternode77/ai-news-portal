...
- Current public homepage cards after product-fit and source-rights gates: 32. Retained JSON records are not treated as reader-visible cards.
...
- Primary public data: `src/data/latest-news.json` (41 records).
...
- Retained source-only/direct-link items: 1002.
