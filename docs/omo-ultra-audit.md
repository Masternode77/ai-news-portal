...
- Current public homepage cards after product-fit and source-rights gates: 30. Retained JSON records are not treated as reader-visible cards.
...
- Primary public data: `src/data/latest-news.json` (37 records).
...
- Retained source-only/direct-link items: 998.
