...
- Current public homepage cards after product-fit and source-rights gates: 24. Retained JSON records are not treated as reader-visible cards.
...
- Archive data: `src/data/archived-news.json` (953 records).
...
- Retained source-only/direct-link items: 983.
