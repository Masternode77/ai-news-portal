...
- Current public homepage cards after product-fit and source-rights gates: 23. Retained JSON records are not treated as reader-visible cards.
...
- Archive data: `src/data/archived-news.json` (950 records).
...
- Retained source-only/direct-link items: 980.
