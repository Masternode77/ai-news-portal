...
- Current public homepage cards after product-fit and source-rights gates: 25. Retained JSON records are not treated as reader-visible cards.
...
- Archive data: `src/data/archived-news.json` (955 records).
...
- Retained source-only/direct-link items: 985.
