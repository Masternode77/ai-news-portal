...
| Upstream integration | BLOCKED (operation) | Read-only `git merge-tree` preflight reports 8 conflicts across the retired dashboard artifact, 4 generated image variants, and 3 generated JSON projections. Raw merging is rejected; integration must follow reconciliation and regenerated output. |
