...
| theregister-data-centre | The Register | **200** (official `tag:on_prem` RSS endpoint, checked 2026-09-06) | https://www.theregister.com/profile/terms_and_conditions_of_use | "use the Website solely for your personal, non-commercial use (b) you will not copy or distribute any part of the Website without our prior written authorisation". | **Low risk** — headline + link only; working feed does not authorize article text or images | No |
...
| datacenterfrontier | Data Center Frontier | **200** RSS (checked 2026-09-06) | https://www.endeavorbusinessmedia.com/endeavor-terms → 404 (Endeavor Business Media moved its terms page) | The current registry feed works, but the terms page remains unavailable. | **Blocked for content use** until terms are reviewed; feed availability alone does not authorize text or images | No |
...
\* The Register's official RSS directory now supplies a working `tag:on_prem` endpoint. Its restrictive terms still limit this record to a prospective headline-and-link lane.
