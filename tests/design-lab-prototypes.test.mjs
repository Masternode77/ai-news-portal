...
const REQUIRED_VIEWS = ['index.html', 'article/index.html', 'states/index.html'];
...
test('built design options expose homepage article and state views without internal metadata', () => {
